...
public class PamaehActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pamaeh);


        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);

        getSupportActionBar().setTitle("Pamaeh");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);


        this.text = (TextView) findViewById(R.id.textAksara);
        this.face = Typeface.createFromAsset(getAssets(), "Sundanese.ttf");
        this.text.setTypeface(this.face);
        this.text1 = (TextView) findViewById(R.id.textSunda);
        this.face = Typeface.createFromAsset(getAssets(), "Sundanese.ttf");
