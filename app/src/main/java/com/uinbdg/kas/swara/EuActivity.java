...
public class EuActivity extends AppCompatActivity implements OnGesturePerformedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Eu");
    ...
    public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture) {
        ...
        if (pn.equals("eu") || pn.equals("eue") || pn.equals("eueu") || pn.equals("eueue")) {
            ab = new Builder(this);
            ab.setTitle("Benar");
