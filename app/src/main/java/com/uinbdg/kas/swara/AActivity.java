...
public class AActivity extends AppCompatActivity implements OnGesturePerformedListener {
    public Button contohKata;
    ...
    public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture) {
        ...
        if (predictions.size() <= 0 || ((Prediction) predictions.get(0)).score <= 3.0d) {
            ...
            ab.show();
        } else if (((Prediction) predictions.get(0)).name.equals("a")) {
            ab = new Builder(this);
            ab.setTitle("Benar");
        ...
        long duration_template = (endTime - startTime + 100);
        Log.d("CANNY DURATION", String.valueOf(duration) + " ms");
        Log.d("TEMPLATE MATCHING", String.valueOf(duration_template) + " ms");
    }
