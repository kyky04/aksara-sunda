...
public class VaActivity extends AppCompatActivity implements OnGesturePerformedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Va");
    ...
    public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture) {
        ...
        if (((Prediction) predictions.get(0)).name.equals("va")) {
            ab = new Builder(this);
            ab.setTitle("Benar");
