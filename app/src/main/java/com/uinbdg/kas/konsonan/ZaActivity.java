...
public class ZaActivity extends AppCompatActivity implements OnGesturePerformedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Za");
    ...
    public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture) {
        ...
        if (((Prediction) predictions.get(0)).name.equals("za")) {
            ab = new Builder(this);
            ab.setTitle("Benar");
