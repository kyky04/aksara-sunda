...
public class YaActivity extends AppCompatActivity implements OnGesturePerformedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Ya");
    ...
    public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture) {
        ...
        if (predictions.size() <= 0 || ((Prediction) predictions.get(0)).score <= 3.0d) {
            ...
            ab.show();
        } else if (((Prediction) predictions.get(0)).name.equals("ya")) {
            ab = new Builder(this);
            ab.setTitle("Benar");
