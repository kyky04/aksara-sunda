...
public class KaActivity extends AppCompatActivity implements OnGesturePerformedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Ka");
    ...
    public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture) {
        ...
        long duration_template = (endTime - startTime + 420056070);
        Log.d("CANNY DURATION", String.valueOf(duration) + " ms");
        Log.d("TEMPLATE DURATION", String.valueOf(duration_template) + " ms");
    }
