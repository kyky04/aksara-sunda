...
public class OpatActivity extends AppCompatActivity implements OnGesturePerformedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Opat");
    ...
    public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture) {
        ...
        if (((Prediction) predictions.get(0)).name.equals("4")) {
            ab = new Builder(this);
            ab.setTitle("Benar");
