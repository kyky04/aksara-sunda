...
public class NolActivity extends AppCompatActivity implements OnGesturePerformedListener {
    ...
    public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture) {
        ...
        if (((Prediction) predictions.get(0)).name.equals("0")) {
            ab = new Builder(this);
            ab.setTitle("Benar");
