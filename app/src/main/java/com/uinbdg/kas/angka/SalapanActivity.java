...
public class SalapanActivity extends AppCompatActivity implements OnGesturePerformedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.salapan);
        ...
        getSupportActionBar().setTitle("Salapan");
    ...
    public void onGesturePerformed(GestureOverlayView overlay, Gesture gesture) {
        ...
        if (((Prediction) predictions.get(0)).name.equals("9")) {
            ab = new Builder(this);
            ab.setTitle("Benar");
